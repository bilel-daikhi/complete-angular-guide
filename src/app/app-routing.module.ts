...
import { canActivate, canActivateChild } from './components/routing/auth-guard.service';
...
const routes: Routes = [
  {path:'observables',component:ObservablesComponent,canActivate:[canActivate]},
  {path:'directives',component:DirectivesComponent},
  {path:'routing',component:RoutingComponent,canActivate:[canActivate],children:[
    {path:':id',component:ChildRouteComponent},
    {path:':id/edit',component:ChildRouteParamsComponent,canActivateChild:[canActivateChild]}
  ]},
  {path:'forms',component:FormsComponent,children:[
    {path:'template',component:TemplateComponent},
    {path:'reactive',component:ReactiveFormsComponent}
  ]},
  {path:'dynamic-component',component:DynamicComponentsComponent,children:[
